...
\parencite{Castro2019-uk,Marchini2014-de}. This study includes two independent selection lines,
...
There are LD data for a natural population of \emph{D. simulans}
...
autocovariance, and allow the fitting of more parameteric model to estimate
population parameters such as the additive genetic variation for fitness
directly from temporal gneomic data alone  \parencite{Buffalo2019-io}.
...
the impact of linked selection in have suggested that XXX to XXX of allele
frequency change over long time periods is driven by selection
\parencite{Mcvicker,Comeron,Elyashiv2016-vt,Russ,Coop}. Thus there is reason to
be hopeful that we could detect this from temporal data, which would help to
resolve the time-scales that linked selection act over. In our reanalysis of
the \textcite{Barghi2019-qy} study, we find evidence of complex linked
selection dynamics, with selection pressures flipping over time due to either
...
contemporary populations, thus we can hope to have a much richer picture of
linked selection as temporal sequencing becomes more common. 
