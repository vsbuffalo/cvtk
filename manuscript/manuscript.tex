...
\parencite{Bergland2014-ij,Machado2018-cs}. Efforts to estimate and quantify
the impact of linked selection in humans and \emph{Drosophila melanogaster}
have suggested that XXX to XXX of allele frequency change over long time
periods is driven by selection \parencite{}. Thus there is reason to be hopeful
that we could detect this from temporal data, which would help to resolve the
