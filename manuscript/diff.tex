...
%DIF ADD manuscript.tex   Thu May 14 12:16:20 2020
...
\DIFaddbegin \setcounter{equation}{0}
\renewcommand{\theequation}{S\arabic{equation}}
\DIFaddend \setcounter{section}{1}
\DIFaddbegin \renewcommand{\thesection}{S\arabic{section}}
\DIFaddend \section*{Supplementary Material}
\beginsupplement
...
\subsection{Replicate \DIFdelbegin \DIFdel{$G$ }\DIFdelend \DIFaddbegin \DIFadd{$G(t)$ }\DIFaddend and Partitioning the Variance in Allele Frequency}
...
\DIFaddend \subsection{The Empirical Neutral Null Windowed Covariance Distribution}
...
\DIFaddbegin \subsection{\DIFadd{Approximating the Reduction in Diversity from $G(t)$}}
\label{supp:reduction-approx}

\DIFadd{To help reconcile our measure of linked selection, $G(t)$, with familiar
...
\subsection{\DIFadd{Simulation Results}}
\label{supp:forward}
...
\subsubsection{\DIFadd{The Effects of the Genetic Architecture under Exponential Directional Selection}}
...
\subsubsection{\DIFadd{Temporal Covariances and $G(t)$ under Gaussian Stabilizing Selection}}
...
\subsubsection{\DIFadd{Convergence Correlations}}
...
\subsubsection{\DIFadd{Sampling in Temporal Blocks}}
...
\subsubsection{\DIFadd{Background Selection}}
...
\subsubsection{\DIFadd{Truncation Selection.}} 
...
\subsubsection{\DIFadd{The Effect of Fixations in the empirical datasets}}
\label{supp:fixation}
