...
\vb{The presence of an unselected control line provides an alternative way to
  partition the effects of linked selection and genetic drift. 
...
\subsection{Proportion of Variance Explained by Linked Selection across Replicates}
...
replicate ($\Delta_{_H} p_t$). By definition, 
