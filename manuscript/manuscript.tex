...
\begin{center}
 ...
 \hline
  \end{tabular}
  \caption{\gc{A summary of the main selection studies we analyzed.}}
\end{center}
...
\subsection{Across-Replicate Covariances}
...
Then, we define a replicate covariance analog of $G$, 
