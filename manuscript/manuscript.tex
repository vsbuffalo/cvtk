...
in frequency change of the Longshanks selection lines. We estimate at least
32\% (95\% CI $[21\%, 48\%]$) of the variance in allele frequency change is
driven by the effects of selection, of which 14\% (95\% CI $[3\%, 33\%]$) is
estimated to be unique to a selection line, and 17\% (95\% CI $[9\%, 23\%]$) is
the effect of shared selection between the two Longshanks selection lines.}
...
\gc{THE WRAY PAPER DATE IS WRONG}
...
Furthermore, \gc{our} estimation methods are intentionally
conservative,\gc{for example they exclude the contribution of selection that
  does not persist across generations and selection that reverses sign
  thus they show be seen as a storng lower bound of the effects of 
selection.}
...
\textcite{Castro2019-uk} \gc{MISSING REF??} studies respectively, which will amplify the role of
...
Throughout the paper, we make use of a block-bootstrapping procedure to 
