...
that while a \vb{substantial} fraction of the initial response is shared over
...
line (Ctrl) \vb{where parents were randomly selected}. Consequently, this
...
changes or recombination breaking up selective alleles; \vb{such reversals are
also theorized to occur after optima shifts (XXX)}.  Such reversals of
selective dynamics could be occurring at other timepoints but the signal of a
change in the direction of selection at particular loci may be washed out when
we calculate our genome-wide average temporal covariances. To address this
