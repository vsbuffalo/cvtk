...
appeared to become negative at future timepoints (see the first two rows in
Figure \ref{fig:figure-1} A). This could be caused by advantageous fitness
...
alleles, or an environmental change in the direction of selection. However, the
...
covariances.  Averaging over such large numbers of loci is necessary to detect
