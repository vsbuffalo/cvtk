...
We can partition the allele frequency change between the two timepoints (20
  ...
  are uncorrelated within replicates, and that only the shared term
  ...
  the control, i.e. $\var(\Delta p_{t,\mathrm{Ctrl}})
  = \var(\Delta_{_D1} p_{t})=\var(\Delta_{_D2} p_{t})$, then we can estimate the increase in variance in allele
