...
\begin{align}
  ...
  \Delta p_{t,\mathrm{Ctrl}} &= \Delta_{_D} p_{t,\mathrm{Ctrl}} + \Delta_{_{U}} p_{t,\mathrm{Ctrl}}
\end{align}


\begin{align}
  (\var(\Delta p_{t,\mathrm{LS1}}) + \var(\Delta p_{t,\mathrm{LS2}}))/2 - \var(\Delta p_{t,\mathrm{Ctrl}}) = 
  \overline{\var(\Delta_{_D} p_{t,\mathrm{LS}})} + \overline{\var(\Delta_{_U} p_{t,\mathrm{LS}})} + \var(\Delta_{_\mathrm{LS}} p_t)
\end{align}

where the bars indicate values averaged 

We note that there very well may be selection acting in the control line...
