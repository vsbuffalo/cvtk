...
tradeoffs to both approaches, but overall not removing fixed sites is a more
conservative, safer approach, and is what we use throughout our paper.
...
shrink the second terms towards zero. 
