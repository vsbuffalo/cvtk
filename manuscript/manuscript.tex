...
\begin{abstract}
%Natural selection  as evident from numerous studies demonstrating
%rapid phenotypic change
  %As we developed
%  in another paper \parencite{Buffalo2019-io}, o
...
\gc{some} with the goal of finding variants that exhibit frequency changes consistent
...
expectation. Mathematically, temporal covariances \gc{are useful} because it is
