...
melanogaster} through Spring-Fall seasons across three years. \gc{If
there was a strong}  pattern of
genome-wide fluctuating selection, we might expect a pattern of positive
covariances between similar seasonal changes\gc{, e.g. Spring-Fall in
  two adjacent years,} and negative covariances between
dissimilar seasonal changes, \gc{e.g. Spring-Fall and Fall-Spring in
  two adjacent years}. However, we find no such signal \gc{over years}; we discuss this
in more depth in Supplementary Materials Section \ref{}.
...
\textcite{Buffalo2019-io}, \gc{if fluctuating selection pressure among
 time-periodsare the dominant genome-wide pattern,} we might expect positive covariances between like
seasons changes \gc{(e.g.} Spring 2010 to Fall 2010 and Spring 2011 to Fall 2011),
and negative covariances between dislike seasonal changes \gc{(e.g.} Fall 2009 to
Spring 2010 and Fall 2010 to Spring 2011). However, while we find
...
selection \gc{as it does not account for genetic drift or other forms
  of hitchhiking.}
