...
with neutral alleles decays \parencite{Buffalo2019-io}. The temporal
covariances per replicate are noisier but this general pattern holds; see
Supplementary Figure \ref{suppfig:barghi-cov-panels}.
...
(Supplementary Figure \ref{suppfig:bergland-correction}, XXX).

\subsection{Estimating $G(t)$ and the Convergence Correlation}
