...
reductions in $N_e$, or, equivalently neutral diversity, we develop some rough
...
For small $t$, it is common to approximate $N_e$ as,

\begin{align}
  N_e \approx \frac{t p_0(1-p_0)}{2 V_T}
\end{align}

Then, the drift-only $N_e$ (that is, removing the effects of linked selection)
replaces $V_T$ with $V_D$, 
...
alone in a constant population of size $N$, is $\E(T_2) = 2N$. The fraction of
