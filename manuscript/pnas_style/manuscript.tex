...
we have confirmed through forward-in-time simulations.  \vb{Finally, through
...
\vb{Future work could refine our $G(t)$ estimates by including selection's
  impact on the variance in allele frequency terms (e.g. see equation 26 of
