...
\textcite{Barghi2019-qy} data, we use $\Delta_{_{10}} p_t$. Between
...
optima shifts of $\mu_\text{sudden} = \{0.1, 0.5, 1\}$, and
(2) very graduate optima shifts of $\mu_\text{gradual} = \{0.001,
0.01\}$ per generation using the same two population simulation scheme
