...
(95\% CIs [0.0087, 0.015]) within 20 generations. This is consistent with
the primary finding of the original \textcite{Barghi2019-qy} study: that
alternative loci contribute to longer term adaptation in different
replicates.  \vb{We note that convergent correlation for the last timepoint
is abnormally high; this is not in fact driven by a single outlier pair of
covariances but all our high for reasons unknown to us.}
...
block-bootstrap confidence interval $[0.31, 0.40]$). \vb{Similarly, we can
...
to the convergence correlation, see XXX).}
