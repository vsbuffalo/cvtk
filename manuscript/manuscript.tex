...
% frequencies as some parents have more or less offspring and heterozygous
% parents randomly pass alleles to down to offspring. Previous efforts to
% disentangle these two processes have used population genomic samples from a
...
\vb{The unselected control line in the Longshanks experiment allows us to
...
\vb{Given evidence of a reversal in the direction of selection at later timepoints
...
\vb{In artificial selection studies with a control (non-selected) line, such as the
