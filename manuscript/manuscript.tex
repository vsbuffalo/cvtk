...
\begin{table}
 ...
 \hline
  ...
  \caption{A summary of the main selection studies we
    analyzed. \gc{$^{\dagger}$ approximate census population size
      during experiment.}} \label{table:study_summary} 
\end{table}
...
populations \gc{were maintained at relatively small census sizes
  (Table \ref{table:study_summary})}, which will amplify the role
