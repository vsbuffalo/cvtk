...
of linked neutral alleles; in contrast, when genetic drift acts alone in a
closed population, these covariances are zero in expectation.  Mathematically,
...
neutral allele frequency changes in one generation predict changes in another
...
linked selection as a reduction in the background level of neutral pairwise
diversity, $\pi_0$. Under the coalescent, $\pi = 2 \mu \E(T_2)$ where $\E(T_2)$
is the pairwise time to coalescence, which under drift alone in a constant
population of size $N$, is $\E(T_2) = 2N$. 
