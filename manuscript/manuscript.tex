...
the impact of selection acting across many genomic \vb{regions}. 
...
%\textcite{Barghi2019-qy}'s design means that we cannot \vb{observe covariances
%between pairs of generations that constitute the estimated covariances between
%ten-generation time intervals
%
