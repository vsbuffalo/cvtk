...
results for a model of Gaussian stabilizing selection (GSS) on a phenotype
...
pressures generating larger convergence correlations. 
...
Supplementary Material Figure \ref{suppfig:sim-expfit-covs}).

Additionally, we explored other selection schemes. We find that the long term
dynamics of the covariances under truncation selection, which generates
...
negative convergent correlations. This suggests that selection experiments
