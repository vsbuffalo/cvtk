...
\author[a,b]{Vince Buffalo}
\author[b]{Graham Coop}
\affil[a]{\footnotesize Population Biology Graduate Group}
...
and re-sequence studies \cite{Barghi2019-qy,Kelly2019-dc}, and an
artificial selection experiment \cite{Castro2019-uk}. These sequencing
...
this general pattern holds; see Supplementary Figure
...
\begin{figure*}
  \centering
  \includegraphics[]{figure-1-revision.pdf}
...
labels; we discuss this in more depth in Supplementary Materials Section
...
\begin{figure*}
  \centering
  \includegraphics[]{figure-2-revision.pdf}
...
\begin{figure*}
  \centering
  \includegraphics[]{figure-4-edited.pdf}
...
\acknow{ We would like to thank the authors of the original studies we have
  ...
  Langley, and Michael Turelli, Matt Osmond, Peter Ralph, Sivan Yair for
