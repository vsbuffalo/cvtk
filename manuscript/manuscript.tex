...
%ime are included or excluded in the temporal covariance calculation can lead
...
% covariance calculations that were at the end or the beginning of a trajectory
% (e.g., as if the site was created by a new mutation or fixed); while this
% ameliorated some of this bias, it still did not lead to $N_e$
% estimates  GUESS I"M UNSURE WHY THIS IS A CRITERIA FOR BEING CORRECT
