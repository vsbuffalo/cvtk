...
with a neutral variant mutation rate of $10^8$. This is roughly analogous to a
XXX chromosome of \emph{Drosophila melanogaster}; however with this small
population size and mutation rate, the population mutation rate $\theta$ for
the entire region leads to far fewer neutral sites to calculate covariances and
other statistics on than expected for a region this length in \emph{D.
melanogaster}. Since our main goal is to understand how the dynamics of
statistics used in the paper and how they are affected by background
selection, fitness model, and trait architecture, we use population
frequencies rather than sampling frequencies.
